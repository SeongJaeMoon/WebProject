...
class WC_Gateway_Iamport_Subscription extends WC_Payment_Gateway {
	...
	public function __construct() {
		...
		$this->supports = array( 'subscriptions', 'subscription_reactivation'/*이것이 있어야 subscription 후 active상태로 들어갈 수 있음*/, 'subscription_suspension', 'subscription_cancellation' , 'refunds', 'subscription_date_changes', 'subscription_amount_changes', 'subscription_payment_method_change_customer' );
	...
	public function enqueue_iamport_script() {
		...
		wp_register_script( 'iamport_script_for_woocommerce_rsa', plugins_url( '/assets/js/iamport.woocommerce.rsa.js',plugin_basename(__FILE__) ), array('jquery'), '20180107');
